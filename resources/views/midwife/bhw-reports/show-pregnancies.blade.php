...
<div class="page-hero fade-in-card mb-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('midwife.bhw-reports.index') }}" class="btn btn-outline-primary btn-sm">
                <i class="bi bi-arrow-left me-1"></i> Back to Reports
            </a>
            <a href="{{ route('midwife.bhw-reports.print', $report->id) }}" class="btn btn-primary btn-sm text-white" target="_blank">
...
<div class="card fade-in-card mb-4">
    <div class="card-header bg-transparent py-3">
        <h5 class="mb-0 fw-700 text-dark"><i class="bi bi-heart-pulse-fill me-2" style="color:var(--danger);"></i>Pregnancy Registry Entries</h5>
    </div>
...
<div class="d-flex justify-content-between mb-4">
    ...
    <a href="{{ route('midwife.bhw-reports.print', $report->id) }}" class="btn btn-primary text-white" target="_blank">
        <i class="bi bi-printer-fill me-1"></i> Print Report
    </a>
</div>
