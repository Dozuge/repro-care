...
<div class="py-4">
    <div class="row justify-content-center">
        <div class="col-xl-9 col-lg-10">
            <div class="mb-3">
                <a href="{{ url()->previous() !== url()->current() ? url()->previous() : route('midwife.dashboard') }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm profile-view-card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 d-flex flex-wrap gap-2">
                        ...
                        @endif
                        <a href="{{ url()->previous() !== url()->current() ? url()->previous() : route('midwife.dashboard') }}" class="btn btn-secondary">
