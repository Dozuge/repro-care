...
@section('title', 'Settings - ReproCare')
...
<div class="settings-page-header fade-in-card">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            <h1><i class="bi bi-gear-fill me-2" style="color:var(--secondary);"></i>Settings</h1>
            <p>Manage your health portal preferences</p>
        </div>
...
<div class="settings-wrap">
    ...
    <div class="settings-sidebar fade-in-card">
        <div class="settings-nav">
            ...
            <a class="settings-nav-item" onclick="showSection('health', this)" href="#">
                <i class="bi bi-heart-pulse-fill" style="color:var(--secondary);"></i> Health Profile
            </a>
            <a class="settings-nav-item" onclick="showSection('emergency', this)" href="#">
                <i class="bi bi-people-fill" style="color:var(--accent-pink);"></i> Emergency Contacts
            </a>
    ...
    <div class="settings-content">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="contact_number" class="form-control" value="{{ old('contact_number', auth()->user()->phone ?: auth()->user()->contact_number) }}" placeholder="Enter phone number">
                            </div>
                            <div class="col-md-6">
                                ...
                                <div style="border:1px solid var(--border); border-radius:16px; overflow:hidden; background:var(--bg-card2);">
                                    <div style="padding:1rem 1rem 0.75rem; border-bottom:1px solid var(--border);">
                                        <div style="font-size:0.92rem; font-weight:700; color:var(--text);">
                                            <i class="bi bi-geo-alt-fill me-2" style="color:var(--secondary);"></i>Registered Location
                                        </div>
                                    ...
                                    <div style="padding:1rem;">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" value="{{ auth()->user()->purok?->name ?? 'Not assigned' }}" readonly>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">City / Province</label>
                                                <input type="text" class="form-control" value="San Carlos City, Pangasinan" readonly>
                                            </div>
                                            <div class="col-12">
                                                <iframe
        ...
        {{-- HEALTH PROFILE (Patient-specific) --}}
        <div class="settings-section" id="section-health">
            <div class="pref-card fade-in-card">
                <div class="pref-card-header">
                    <div class="pref-card-header-icon" style="background:rgba(244,63,142,0.12);color:var(--secondary);"><i class="bi bi-heart-pulse-fill"></i></div>
                    <div><h6>Health Profile</h6><p>Update your health-related information</p></div>
                </div>
                <div class="pref-card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" value="{{ auth()->user()->height ?? '' }}" placeholder="e.g., 160">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Weight (kg)</label>
                            <input type="number" class="form-control" value="{{ auth()->user()->weight ?? '' }}" step="0.1" placeholder="e.g., 55.5">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Average Cycle Length (days)</label>
                            <input type="number" class="form-control" value="{{ auth()->user()->cycle_length ?? 28 }}" min="21" max="45">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Allergies / Medical Notes</label>
                            <textarea class="form-control" rows="2" placeholder="Note any allergies or medical conditions...">{{ auth()->user()->medical_notes ?? '' }}</textarea>
                        </div>
                        <div class="col-12 d-flex gap-2 pt-1">
        ...
        <div class="settings-section" id="section-emergency">
            <div class="pref-card fade-in-card">
                <div class="pref-card-header">
                    <div class="pref-card-header-icon" style="background:rgba(244,63,142,0.12);color:var(--accent-pink);"><i class="bi bi-people-fill"></i></div>
                ...
                <div class="pref-card-body">
                    <form action="{{ route('profile.emergency-contacts.update') }}" method="POST">
                        ...
                        <div class="mb-4 pb-3" style="border-bottom: 1px solid var(--border);">
                            <h6 class="mb-3" style="color: var(--primary-light); font-weight: 700; font-size: 0.9rem;">
                                <i class="bi bi-1-circle-fill"></i> Primary Emergency Contact
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        {{-- Secondary Contact --}}
                        <div class="mb-3">
                            <h6 class="mb-3" style="color: var(--text-muted); font-weight: 700; font-size: 0.9rem;">
                                <i class="bi bi-2-circle-fill"></i> Secondary Emergency Contact (Optional)
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Full Name</label>
                        ...
                        <div class="mb-3">
                            <h6 class="mb-3" style="color: var(--text-muted); font-weight: 700; font-size: 0.9rem;">
                                <i class="bi bi-3-circle-fill"></i> Tertiary Emergency Contact (Optional)
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Full Name</label>
        ...
        <div class="settings-section" id="section-notifications">
            <div class="pref-card fade-in-card">
                ...
                <div class="pref-card-body">
                    @foreach([
                        ['id'=>'period_reminder',   'title'=>'Period Reminders',         'desc'=>'Get reminded 3 days before predicted period',   'on'=>true],
                        ['id'=>'checkup_reminder',  'title'=>'Checkup Reminders',        'desc'=>'Remind me about upcoming scheduled checkups',   'on'=>true],
                        ['id'=>'ovulation_alert',   'title'=>'Ovulation Window Alerts',  'desc'=>'Notify when fertile window is approaching',     'on'=>true],
                        ['id'=>'pregnancy_updates', 'title'=>'Pregnancy Weekly Updates', 'desc'=>'Weekly milestone updates during pregnancy',     'on'=>false],
                        ['id'=>'forum_activity',    'title'=>'Forum Activity',            'desc'=>'Replies and mentions in forum discussions',     'on'=>false],
                    ] as $t)
                    <div class="pref-row">
        ...
        <div class="settings-section" id="section-privacy">
            <div class="pref-card fade-in-card">
                <div class="pref-card-header">
                    <div class="pref-card-header-icon" style="background:rgba(155,54,255,0.12);color:var(--accent-violet);"><i class="bi bi-eye-fill"></i></div>
            ...
            <div class="pref-card fade-in-card">
                <div class="pref-card-header">
                    ...
                    <div><h6>Data Management</h6><p>Download or delete your health data</p></div>
                </div>
                <div class="pref-card-body">
                    ...
                    <div class="danger-zone">
                        ...
                        <p style="font-size:0.82rem;color:var(--text-muted);margin-bottom:0.85rem;">Deleting your account permanently removes all your health records and cannot be undone.</p>
