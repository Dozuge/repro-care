    ...
    <div class="print-container">
        ...
        <div class="no-print mb-4 d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('bhw.reports.show', $report->id) }}" class="btn btn-outline-secondary">
        ...
        <div class="report-header">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <p class="text-muted mb-0">Barangay Health Worker Pregnancy Report</p>
                </div>
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-muted"><span class="badge bg-secondary">Pregnancies</span></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless table-sm mb-0">
                            ...
                            <tr>
                                <td class="text-muted">Total Pregnancies:</td>
        ...
        <div class="card">
            <div class="card-header bg-light">
                <h6 class="mb-0"><i class="bi bi-heart"></i> Pregnancy Records Detail</h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mb-0">
                        ...
                        <tbody>
                            @forelse($pregnancies as $index => $pregnancy)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $pregnancy->created_at->format('M d, Y') }}</td>
                                    <td>
                                ...
                                @if($pregnancy->notes)
                                    <tr class="table-light">
                                        <td></td>
                                        <td colspan="7">
                                            <small><strong>Notes:</strong> {{ $pregnancy->notes }}</small>
                                        </td>
                                    </tr>
                                @endif
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center py-4">
                                        No pregnancies found for this report period.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
