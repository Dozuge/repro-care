...
<div class="py-4">
    <div class="page-hero fade-in-card mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3" style="position:relative;z-index:1;">
            <div>
                <div class="page-hero-title"><i class="bi bi-send-plus-fill me-2"></i>Create Checkup Referral</div>
            ...
            <form method="POST" action="{{ route('bhw.referrals.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <label class="btn btn-outline-primary" for="patient_registered">Registered Woman</label>
                        ...
                        <label class="btn btn-outline-primary" for="patient_walk_in">Existing Walk-in</label>
                        ...
                        <label class="btn btn-outline-primary" for="patient_new_walk_in">New Walk-in</label>
                    </div>
                </div>

                <div id="existing-patient-section" class="mb-4">
                    <div id="registered-patient-group">
                        <label class="form-label fw-semibold">Search Registered Woman</label>
                        ...
                        <select name="user_id" id="registered-patient-select" class="form-select">
                            <option value="">Select registered woman</option>
                    ...
                    <div id="walk-in-patient-group" class="d-none">
                        <label class="form-label fw-semibold">Search Existing Walk-in</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="purok_id" class="form-select">
                                ...
                                @foreach($puroks as $purok)
                                    <option value="{{ $purok->id }}" {{ (string) old('purok_id') === (string) $purok->id ? 'selected' : '' }}>{{ $purok->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-12">
...
function togglePatientType() {
    ...
    document.querySelector('select[name="purok_id"]').required = newWalkIn;
}
