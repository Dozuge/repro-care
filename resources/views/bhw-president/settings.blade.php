...
<style>
    ...
    .settings-nav-item.active { background: linear-gradient(135deg, var(--primary-subtle), rgba(218,54,255,0.10)); color: var(--primary-light); border-color: var(--border-glass); font-weight: 600; }
    ...
    <div class="settings-content">
        ...
        <div class="settings-section" id="section-notifications">
            <div class="pref-card fade-in-card">
                ...
                <div class="pref-card-body">
                    @foreach([
                        ['id'=>'email_patients',  'title'=>'New Patient Approvals',     'desc'=>'Notify when new patients await approval', 'on'=>true],
                        ['id'=>'email_bhw',       'title'=>'BHW Activity',             'desc'=>'Updates on BHW performance', 'on'=>true],
                        ['id'=>'email_reports',   'title'=>'Monthly Reports',          'desc'=>'Receive monthly report summaries', 'on'=>false],
                    ] as $t)
                    <div class="pref-row">
